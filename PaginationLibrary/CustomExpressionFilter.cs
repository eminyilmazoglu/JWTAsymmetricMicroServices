...
namespace PaginationLibrary
{
    public static class CustomExpressionFilter<T> where T : class
    {
        ...
        public static Expression<Func<T, bool>> CustomFilter(List<ColumnFilter> columnFilters, T className)
        {
            ...
            try
            {
                ...
                var parameter = Expression.Parameter(typeof(T), className.GetType().Name.ToLower());
